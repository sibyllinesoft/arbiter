...
export declare function checkCompatibility(_versions: Partial<VersionSet>, _allowCompat?: boolean): Promise<CompatibilityResult>;
export declare function executeMigration(_component: string, _fromVersion: string, _toVersion: string): Promise<{
    success: boolean;
