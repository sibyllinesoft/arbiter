 ...
 * Performance measurement utilities for CLI operations.
 *
 * Provides tracking, benchmarking, and reporting capabilities
 * for measuring CLI command execution times.
 */
...
export class PerformanceTracker {
  ...
  printReport(title = "Performance Report"): void {
    ...
    /** Measurements sorted by duration descending. */
 ...
 * @param tracker - Optional tracker to record measurement
 ...
 * @param name - Optional custom measurement name
...
export class CLIBenchmark {
   ...
   * @param command - Command name to get stats for
   * @returns Statistics object or null if no results
   */
  getStats(command: string): {
    ...
    /** Results filtered by command name. */
    ...
    /** Durations sorted ascending for percentile calculation. */
   ...
   */
  printReport(): void {
    /** Unique command names from results. */
