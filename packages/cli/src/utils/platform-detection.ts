 ...
 */
export async function detectPlatform(projectDir: string = "."): Promise<PlatformContext> {
 ...
 */
function generatePlatformSuggestions(platform: PlatformContext["detected"], projectDir: string): PlatformSuggestion[] {
