...
import { writeFileWithHooks } from "@/services/generate/hook-executor.js";
import { joinRelativePath } from "@/services/generate/shared.js";
...
export function buildDefaultServiceDockerArtifacts(
  ...
  switch (language) {
    case "typescript":
    case "javascript":
      return buildTypeScriptServiceDockerArtifacts(metadata);
    case "python":
      return buildPythonServiceDockerArtifacts(metadata);
    case "go":
      return buildGoServiceDockerArtifacts(metadata);
    case "rust":
      return buildRustServiceDockerArtifacts(metadata);
    default:
      console.log(
        chalk.dim(
...
export function buildDefaultClientDockerArtifacts(
  ...
  switch (metadata.language) {
    case "typescript":
    case "javascript":
      return buildTypeScriptClientDockerArtifacts(metadata);
    default:
      console.log(
        chalk.dim(
