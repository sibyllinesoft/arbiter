...
Install dependencies with your preferred package manager (npm, pnpm, yarn, or bun) and run the usual `install`, `dev`, `test`, and `build` scripts.
...
Run `npm test` (or the equivalent command for your manager) to execute the suite.
...
echo "   2. npm install (or your preferred manager)"
echo "   3. npm run dev"
