 ...
 */
async function generateSchemaDocumentation(options: DocsOptions, _config: Config): Promise<number> {
 ...
 */
async function generateApiDocumentation(options: DocsOptions, _config: Config): Promise<number> {
