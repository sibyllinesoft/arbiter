...
describe("GitHub Sync Body Generation", () => {
  ...
  test("should handle milestone description generation", () => {
    const epic: Epic = {
      ...
      status: "in_progress",
      tasks: [
        { id: "task-1", name: "Task 1", type: "feature", priority: "high", status: "todo", estimatedHours: 4 },
        { id: "task-2", name: "Task 2", type: "bug", priority: "medium", status: "todo", estimatedHours: 2 }
      ]
    };
