...
import { validateSpecification, formatWarnings, type ValidationResult } from "../warnings.js";
...
describe("Validation Warning System", () => {
  ...
  describe("Core Validation Function", () => {
    it("should return no warnings for complete valid spec", () => {
      ...
      if (result.warnings.length > 0) {
        console.log("Warnings:", result.warnings.map(w => `${w.category}: ${w.message}`));
      }
  ...
  describe("Testing Validation", () => {
    ...
    it("should warn when missing integration tests", () => {
      ...
      const integrationWarning = result.warnings.find(w => w.message.includes("Missing integration tests"));
    ...
    it("should warn when missing e2e tests", () => {
      ...
      const e2eWarning = result.warnings.find(w => w.message.includes("Missing end-to-end tests"));
    ...
    it("should warn when test suites have no cases", () => {
      const spec = {
        ...minimalValidSpec,
        tests: [
          { name: "Empty Test Suite", type: "unit", cases: [] }
        ]
      };
      const result = validateSpecification(spec);
  ...
  describe("Epics and Tasks Validation", () => {
    ...
    it("should warn when source services exist but no tasks defined", () => {
      ...
      const taskWarning = result.warnings.find(w => w.message.includes("no implementation tasks defined"));
    ...
    it("should warn when source service has no corresponding epic", () => {
      ...
      const orphanWarning = result.warnings.find(w => w.message.includes("has no corresponding epic"));
  ...
  describe("Service Definition Validation", () => {
    it("should warn when service missing language", () => {
      ...
      const langWarning = result.warnings.find(w => w.message.includes("missing language specification"));
    ...
    it("should warn when service missing ports", () => {
      ...
      const portWarning = result.warnings.find(w => w.message.includes("has no port definitions"));
    ...
    it("should warn when service missing resources", () => {
      ...
      const resourceWarning = result.warnings.find(w => w.message.includes("missing resource specifications"));
    ...
    it("should warn when bespoke service missing environment config", () => {
      ...
      const envWarning = result.warnings.find(w => w.message.includes("missing environment configuration"));
  ...
  describe("Documentation Validation", () => {
    ...
    it("should warn when missing project description", () => {
      const spec = { ...minimalValidSpec };
      delete spec.metadata.description;
      const result = validateSpecification(spec);
      
      const descWarning = result.warnings.find(w => w.message.includes("Missing project description"));
    ...
    it("should warn when API services exist but no API docs", () => {
      ...
      const apiDocWarning = result.warnings.find(w => w.message.includes("no API documentation specified"));
  ...
  describe("Security Validation", () => {
    it("should warn when admin routes not protected", () => {
      ...
      const securityWarning = result.warnings.find(w => w.message.includes("Admin routes found without authentication"));
    ...
    it("should warn when missing security configuration", () => {
      ...
      const secWarning = result.warnings.find(w => w.message.includes("Missing security configuration"));
  ...
  describe("Performance Validation", () => {
    it("should warn when missing performance specs", () => {
      const spec = { ...minimalValidSpec };
      delete spec.performance;
      const result = validateSpecification(spec);
      
      const perfWarning = result.warnings.find(w => w.message.includes("Missing performance specifications"));
    ...
    it("should warn when bespoke service missing resource limits", () => {
      ...
      const limitWarning = result.warnings.find(w => w.message.includes("missing resource limits"));
  ...
  describe("UI Completeness Validation", () => {
    it("should warn when routes missing components", () => {
      ...
      const compWarning = result.warnings.find(w => w.message.includes("missing component specifications"));
    ...
    it("should warn when routes missing capabilities", () => {
      ...
      const capWarning = result.warnings.find(w => w.message.includes("missing capability definitions"));
    ...
    it("should warn when UI routes exist but no locators", () => {
      ...
      const locatorWarning = result.warnings.find(w => w.message.includes("no test locators specified"));
  ...
  describe("Data Management Validation", () => {
    ...
    it("should warn when database exists but no migration strategy", () => {
      ...
      const migrationWarning = result.warnings.find(w => w.message.includes("no migration strategy defined"));
  ...
  describe("Observability Validation", () => {
    it("should warn when services exist but no observability config", () => {
      ...
      const obsWarning = result.warnings.find(w => w.message.includes("no observability configuration"));
    ...
    it("should warn when missing logging configuration", () => {
      ...
      const logWarning = result.warnings.find(w => w.message.includes("Missing logging configuration"));
    ...
    it("should warn when missing monitoring configuration", () => {
      ...
      const monitorWarning = result.warnings.find(w => w.message.includes("Missing monitoring configuration"));
  ...
  describe("Environment Configuration Validation", () => {
    it("should warn when missing environment configurations", () => {
      ...
      const envWarning = result.warnings.find(w => w.message.includes("Missing environment configurations"));
      expect(envWarning).toBeDefined();
    });
    ...
    it("should warn when missing development environment", () => {
      ...
      const devWarning = result.warnings.find(w => w.message.includes("Missing development environment"));
    ...
    it("should warn when missing production environment", () => {
      ...
      const prodWarning = result.warnings.find(w => w.message.includes("Missing production environment"));
