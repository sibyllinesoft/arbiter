...
export class ConstraintEnforcer extends EventEmitter {
   ...
   */
  validateSandboxCompliance(operationType: string, isDirectToolExecution: boolean, operationId?: string): void {
   ...
   */
  validateIdempotency(operation: string, inputs: unknown, expectedOutput: unknown, actualOutput: unknown, operationId?: string): void {
