...
program
  ...
  .description('validate CUE files with comprehensive validation checks')
  ...
  .option('--best-practices', 'enable best practices validation', true)
  .option('--no-best-practices', 'disable best practices validation')
  .option('--rules <rules>', 'comma-separated list of custom validation rules')
  .option('--skip-warnings', 'skip warning output')
  .option('--fixable', 'show hint about automatically fixable issues')
  .option('-v, --verbose', 'verbose output with detailed errors')
