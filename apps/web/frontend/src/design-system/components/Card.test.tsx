...
describe('Card', () => {
  ...
  describe('variants', () => {
    it.each([['default'], ['interactive'], ['elevated'], ['outlined'], ['ghost']])(
      'renders %s variant correctly',
      variant => {
        render(
          <Card variant={variant as any} data-testid={`${variant}-card`}>
            Test
          </Card>
        );
  ...
  describe('sizes', () => {
    it.each([['sm'], ['md'], ['lg'], ['xl']])('renders %s size correctly', size => {
      render(
        <Card size={size as any} data-testid={`${size}-card`}>
          Test
        </Card>
      );
