...
describe('Toast', () => {
  ...
  describe('actions', () => {
    ...
    it('action is clickable', async () => {
      ...
      const action = <button data-testid="action" onClick={handleActionClick}>Action</button>
  ...
  describe('custom styling', () => {
    it('applies custom className', () => {
      const { container } = render(<Toast title="Custom Class" className="custom-toast" visible={true} />)
