...
export const Card = forwardRef<HTMLDivElement, CardProps>(({
  ...
  const variantClasses = {
    ...
    interactive: cn(
      ...
      selected && 'border-blue-500 ring-1 ring-blue-500 ring-opacity-20',
      disabled && 'cursor-not-allowed opacity-60 hover:border-graphite-200 hover:shadow-sm active:scale-100'
    ),
    elevated: cn(
  ...
  return (
    ...
    >
      ...
      <div className={sizeClass.gap}>
        ...
        {children && (
          <div className={cn(
            hasHeader && hasFooter ? sizeClass.bodyPadding : 
            hasHeader ? sizeClass.footerPadding :
            hasFooter ? sizeClass.headerPadding :
            sizeClass.padding,
            bodyClassName
          )}>
            {children}
