...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible tab navigation component for organizing content into separate panels. Features badge support, disabled states, and accessible keyboard navigation.',
      },
    },
  },
  tags: ['autodocs'],
...
const SampleContent = ({ title, icon: Icon, content }: { title: string; icon?: any; content: string }) => (
...
const basicTabs: TabItem[] = [
  {
    id: 'overview',
    label: 'Overview',
    content: <SampleContent title="Overview" content="This is the overview tab content. It provides a general introduction to the current context." />
  },
  {
    id: 'details',
    label: 'Details',
    content: <SampleContent title="Details" content="Detailed information and specifications are displayed here. This tab contains comprehensive data." />
  },
  {
    id: 'settings',
    label: 'Settings',
    content: <SampleContent title="Settings" content="Configuration options and preferences can be managed in this tab." />
  }
];
...
const tabsWithBadges: TabItem[] = [
  {
    ...
    label: 'Code',
    badge: '12',
    content: <SampleContent title="Code Files" icon={Code} content="12 code files in this project. Review and edit your source code here." />
  },
  {
    id: 'docs',
    label: 'Documentation',
    badge: '5',
    content: <SampleContent title="Documentation" icon={FileText} content="5 documentation files available. Technical specifications and guides." />
  },
  {
    id: 'issues',
    label: 'Issues',
    badge: 'NEW',
    content: <SampleContent title="Issues" content="Track bugs, feature requests, and other project issues here." />
  },
  {
    id: 'config',
    label: 'Config',
    content: <SampleContent title="Configuration" icon={Settings} content="Project configuration files and settings management." />
  }
];
...
const tabsWithDisabled: TabItem[] = [
  {
    id: 'database',
    label: 'Database',
    content: <SampleContent title="Database" icon={Database} content="Database connection and management tools." />
  },
  {
    id: 'api',
    label: 'API',
    content: <SampleContent title="API" icon={Globe} content="RESTful API endpoints and documentation." />
  },
  {
    id: 'users',
    label: 'Users',
    disabled: true,
    content: <SampleContent title="Users" icon={User} content="User management (requires premium subscription)." />
  },
  {
    id: 'analytics',
    label: 'Analytics',
    disabled: true,
    content: <SampleContent title="Analytics" content="Advanced analytics and reporting (coming soon)." />
  }
];
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Basic tab navigation with three simple tabs. Click tabs to switch between content panels.',
      },
    },
  },
};
...
export const WithBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Tabs can display badges for notifications, counts, or status indicators. Badges adapt their styling based on the active state.',
      },
    },
  },
};
...
export const WithDisabledTabs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Some tabs can be disabled to indicate unavailable functionality. Disabled tabs are not clickable and have reduced opacity.',
      },
    },
  },
};
...
export const ManyTabs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'When there are many tabs, they will wrap to maintain usability. The last two tabs are disabled to demonstrate mixed states.',
      },
    },
  },
};
...
export const DeveloperToolTabs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world example of tabs in a developer tool interface with editor, console, network monitor, and security tabs.',
      },
    },
  },
};
...
export const CustomStyling: Story = {
        ...
        content: (
          <div className="h-64 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs font-medium">12 new</span>
            </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example showing how tabs can be styled with custom backgrounds and integrated into designed interfaces.',
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive playground to experiment with Tabs props. Use the controls panel to test different configurations.',
      },
    },
  },
};