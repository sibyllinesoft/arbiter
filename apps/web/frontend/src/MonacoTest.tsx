                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
                    <div className="bg-gray-50 px-4 py-2 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            Testing CUE language features: package declarations, imports, constraints, 
                            unification operators, templates, and more.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow border">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <span>Keywords: <code>package</code>, <code>import</code>, <code>if</code></span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-4 h-4 rounded" style={{backgroundColor: '#1976D2'}}></div>
                                <span>Types: <code>string</code>, <code>int</code>, <code>bool</code></span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-4 h-4 rounded" style={{backgroundColor: '#CE9178'}}></div>
                                <span>Strings: <code>"arbiter"</code>, <code>"/health"</code></span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-4 h-4 rounded" style={{backgroundColor: '#098658'}}></div>
                                <span>Numbers: <code>8080</code>, <code>3000</code></span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-4 h-4 rounded" style={{backgroundColor: '#FF9F43'}}></div>
                                <span>Unification: <code>&</code>, <code>|</code></span>
                            </div>
                            <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span>Comments: <code>// CUE Language Test</code></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    if ((window as any).monaco) {
                                        ...
                                        console.log('Sample tokenization:', monaco.editor.tokenize('package test', 'cue'));
                                    }
                                }}
