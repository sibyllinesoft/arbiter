...
import type { WsEvent, WebSocketMessage } from '../../types/api';
import type { TimerService, LocationService, WebSocketFactory } from '../websocket';
...
describe('WebSocketService (Comprehensive)', () => {
  ...
  beforeEach(() => {
    ...
    mockWebSocket = new MockWebSocket('wss://localhost:3000/api/ws?project_id=test-project');
  ...
  describe('Connection Management', () => {
    it('should connect to WebSocket successfully', async () => {
      ...
      expect(mockWebSocketFactory.create).toHaveBeenCalledWith(
        'wss://localhost:3000/api/ws?project_id=test-project'
      );
  ...
  describe('Message Handling', () => {
    ...
    it('should validate event structure', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        'Invalid WebSocket event structure:',
  ...
  describe('Event Subscription Management', () => {
    ...
    it('should subscribe and unsubscribe event handlers', () => {
      ...
      const unsubscribe2 = service.subscribe(handler2);
  ...
  describe('Reconnection Logic', () => {
    ...
    it('should handle reconnection without stored URL', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        'Cannot reconnect: no previous URL available'
      );
