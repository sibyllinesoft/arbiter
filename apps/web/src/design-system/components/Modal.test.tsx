...
describe('Modal', () => {
  ...
  describe('sizes', () => {
    it.each([
      ...
      render(<Modal open={true} onClose={() => {}} size={size as any}>Content</Modal>)
  ...
  describe('variants', () => {
    ...
    it('applies variant-specific border colors', () => {
      const { rerender } = render(
        <Modal open={true} onClose={() => {}} variant="success">Content</Modal>
      )
      
      let dialog = screen.getByRole('dialog')
      expect(dialog).toHaveClass('border-l-4', 'border-green-500')

      rerender(<Modal open={true} onClose={() => {}} variant="error">Content</Modal>)
  ...
  describe('close button', () => {
    ...
    it('hides close button when showCloseButton is false', () => {
      render(<Modal open={true} onClose={() => {}} showCloseButton={false}>Content</Modal>)
  ...
  describe('backdrop interactions', () => {
    ...
    it('does not close when backdrop is clicked and closeOnBackdropClick is false', async () => {
      ...
      render(<Modal open={true} onClose={onClose} closeOnBackdropClick={false}>Content</Modal>)
  ...
  describe('loading state', () => {
    it('shows loading overlay when loading is true', () => {
      render(<Modal open={true} onClose={() => {}} loading>Content</Modal>)
    ...
    it('does not show loading overlay when loading is false', () => {
      render(<Modal open={true} onClose={() => {}} loading={false}>Content</Modal>)
  ...
  describe('footer', () => {
    it('renders custom footer', () => {
      ...
      render(<Modal open={true} onClose={() => {}} footer={footer}>Content</Modal>)
      
      expect(screen.getByText('Custom Footer')).toBeInTheDocument()
    })

    it('renders default footer when showDefaultFooter is true', () => {
      render(<Modal open={true} onClose={() => {}} showDefaultFooter>Content</Modal>)
    ...
    it('default footer close button calls onClose', async () => {
      ...
      render(<Modal open={true} onClose={onClose} showDefaultFooter>Content</Modal>)
  ...
  describe('positioning', () => {
    ...
    it('positions modal at top when centered is false', () => {
      render(<Modal open={true} onClose={() => {}} centered={false}>Content</Modal>)
  ...
  describe('z-index', () => {
    ...
    it('uses custom z-index', () => {
      render(<Modal open={true} onClose={() => {}} zIndex={100}>Content</Modal>)
