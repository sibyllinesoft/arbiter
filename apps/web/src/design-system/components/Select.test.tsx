...
describe('Select', () => {
  ...
  describe('multiple selection', () => {
    ...
    it('deselects option when clicked again in multiple mode', async () => {
      ...
      const appleOption = screen.getAllByText('Apple')[1] // Second instance is in the dropdown
    ...
    it('shows clear button for multiple selections', async () => {
      const onChange = vi.fn()
      const user = userEvent.setup()
      render(<Select options={mockOptions} multiple value={['apple', 'banana']} onChange={onChange} />)
  ...
  describe('floating label', () => {
    ...
    it('shows description below input for floating label', () => {
      render(<Select options={mockOptions} label="Label" description="Description" floatingLabel />)
  ...
  describe('option features', () => {
    ...
    it('shows check mark for selected options', async () => {
      ...
      const appleOption = appleOptions[1].closest('button') // Second instance is in dropdown
    ...
    it('highlights selected options', async () => {
      ...
      const appleOptions = screen.getAllByText('Apple')
      const appleOption = appleOptions[1].closest('button') // Second instance is in dropdown
      expect(appleOption).toHaveClass('bg-blue-50', 'text-blue-700')
    })
  })
