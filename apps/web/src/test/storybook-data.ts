  ...
  duplicates: [
    {
      ...
      locations: [
        '/specs/authentication.yml:REQ1.1',
        '/specs/api-endpoints.yml:REQ3.2',
      ],
    },
    {
      ...
      locations: [
        '/specs/authentication.yml:T1',
        '/specs/api-endpoints.yml:T7',
      ],
    },
  ] as Duplicate[],
});
...
export const generateFileTree = () => ({
  ...
  children: [
      ...
      children: [
        {
          ...
          type: 'directory' as const,
          children: [
            { name: 'UserAuth.tsx', type: 'file' as const, size: '2.4 KB', modified: '2 hours ago' },
            { name: 'ProductList.tsx', type: 'file' as const, size: '5.1 KB', modified: '1 day ago' },
            { name: 'CheckoutForm.tsx', type: 'file' as const, size: '3.8 KB', modified: '3 hours ago' },
        ...
        },
        {
          ...
          type: 'directory' as const,
          children: [
            { name: 'authService.ts', type: 'file' as const, size: '4.5 KB', modified: '4 hours ago' },
            { name: 'apiClient.ts', type: 'file' as const, size: '6.7 KB', modified: '1 day ago' },
            { name: 'localStorage.ts', type: 'file' as const, size: '0.9 KB', modified: '1 week ago' },
          ],
        },
        {
          name: 'types',
    ...
    },
    {
      ...
      type: 'directory' as const,
      children: [
        { name: 'authentication.yml', type: 'file' as const, size: '3.2 KB', modified: '1 hour ago' },
        { name: 'api-endpoints.yml', type: 'file' as const, size: '5.8 KB', modified: '2 hours ago' },
        { name: 'database.yml', type: 'file' as const, size: '2.1 KB', modified: '1 day ago' },
        { name: 'ui-components.yml', type: 'file' as const, size: '4.3 KB', modified: '3 hours ago' },
      ],
    },
    {
      name: 'tests',
      ...
      children: [
        {
          ...
          type: 'directory' as const,
          children: [
            { name: 'auth.test.ts', type: 'file' as const, size: '2.7 KB', modified: '4 hours ago' },
            { name: 'api.test.ts', type: 'file' as const, size: '3.9 KB', modified: '1 day ago' },
            { name: 'components.test.tsx', type: 'file' as const, size: '5.4 KB', modified: '2 days ago' },
          ],
        },
...
export const generateDiagramData = () => ({
  ...
  siteDiagram: {
    routes: [
      { id: 'route-login', path: '/auth/login', method: 'POST', handler: 'authController.login', dependencies: ['db', 'redis'] },
      { id: 'route-register', path: '/auth/register', method: 'POST', handler: 'authController.register', dependencies: ['db', 'email'] },
      { id: 'route-profile', path: '/api/profile', method: 'GET', handler: 'userController.getProfile', dependencies: ['db', 'auth'] },
      { id: 'route-products', path: '/api/products', method: 'GET', handler: 'productController.list', dependencies: ['db', 'cache'] },
    ],
    dependencies: [
  ...
  fsmDiagram: {
    ...
    transitions: [
      ...
      { from: 'loading', to: 'error', event: 'LOGIN_FAILED', guard: 'attempts < 5', action: 'incrementAttempts' },
      { from: 'loading', to: 'locked', event: 'LOGIN_FAILED', guard: 'attempts >= 5', action: 'lockAccount' },
  ...
  viewDiagram: {
    tokens: [
      ...
      { id: 'req1.2', label: 'Password Strength', type: 'requirement', position: { x: 150, y: 150 } },
