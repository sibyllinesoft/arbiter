  ...
  describe('variants', () => {
    ...
    it('warning prop overrides variant', () => {
      const { container } = render(
        <Radio label="Test" variant="success" warning="Warning message" />
      );
      const radio = container!.querySelector('.border-amber-300');
      expect(radio).toBeInTheDocument();
    ...
    it('success prop overrides variant', () => {
      const { container } = render(
        <Radio label="Test" variant="error" success="Success message" />
      );
      const radio = container!.querySelector('.border-emerald-300');
      expect(radio).toBeInTheDocument();
...
describe('RadioGroup', () => {
  ...
  describe('layout', () => {
    ...
    it('renders horizontally when direction is horizontal', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} direction="horizontal" />
      );
  ...
  describe('variants and states', () => {
    it('applies variant to all radio options', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} variant="error" />
      );
    ...
    it('shows error message and applies error variant', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} error="Error message" />
      );
      expect(screen.getByText('Error message')).toBeInTheDocument();
      const errorRadios = container!.querySelectorAll('.border-red-300');
      expect(errorRadios).toHaveLength(3);
    ...
    it('shows warning message and applies warning variant', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} warning="Warning message" />
      );
      expect(screen.getByText('Warning message')).toBeInTheDocument();
    ...
    it('shows success message and applies success variant', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} success="Success message" />
      );
      expect(screen.getByText('Success message')).toBeInTheDocument();
    ...
    it('error prop overrides variant', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} variant="success" error="Error" />
      );
      const errorRadios = container!.querySelectorAll('.border-red-300');
      expect(errorRadios).toHaveLength(3);
    });
  ...
  describe('accessibility', () => {
    ...
    it('supports keyboard navigation between options', async () => {
      ...
      expect(radios[1] as Element).toHaveFocus();

      await user.keyboard('[ArrowUp]');
      expect(radios[0] as Element).toHaveFocus();
    });
  ...
  describe('custom styling', () => {
    it('applies custom className to group container', () => {
      const { container } = render(
        <RadioGroup name="test" options={mockOptions} className="custom-group" />
      );
