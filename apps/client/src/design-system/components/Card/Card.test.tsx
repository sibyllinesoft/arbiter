...
describe("Card", () => {
  ...
  describe("variants", () => {
    ...
    type Variant = (typeof testVariants)[number][number];
    it.each(testVariants)("renders %s variant correctly", (variant: Variant) => {
      render(
    ...
    it("applies interactive styles and cursor for interactive variant", () => {
      render(
        <Card variant="interactive" data-testid="interactive-card">
          Test
        </Card>,
      );
  ...
  describe("sizes", () => {
    const testSizes = [["sm"], ["md"], ["lg"], ["xl"]] as const;
    type Size = (typeof testSizes)[number][number];
    it.each(testSizes)("renders %s size correctly", (size: Size) => {
      render(
    ...
    it("applies correct border radius for sizes", () => {
      const { rerender } = render(
        <Card size="sm" data-testid="size-card">
          Test
        </Card>,
      );
      ...
      rerender(
        <Card size="lg" data-testid="size-card">
          Test
        </Card>,
      );
      ...
      rerender(
        <Card size="xl" data-testid="size-card">
          Test
        </Card>,
      );
      expect(screen.getByTestId("size-card")).toHaveClass("rounded-xl");
  ...
  describe("loading state", () => {
    ...
    it("prevents interactions when loading", () => {
      ...
      render(
        <Card loading onClick={handleClick} data-testid="loading-card">
          Content
        </Card>,
      );
  ...
  describe("disabled state", () => {
    it("applies disabled styles", () => {
      render(
        <Card disabled data-testid="disabled-card">
          Content
        </Card>,
      );
    ...
    it("prevents click when disabled", () => {
      const handleClick = vi.fn();
      render(
        <Card disabled onClick={handleClick} data-testid="disabled-card">
          Content
        </Card>,
      );
  ...
  describe("selected state", () => {
    ...
    it("applies selected styles with different variants", () => {
      const { rerender } = render(
        <Card selected variant="default" data-testid="selected-card">
          Content
        </Card>,
      );
      const card = screen.getByTestId("selected-card");
      ...
      rerender(
        <Card selected variant="outlined" data-testid="selected-card">
          Content
        </Card>,
      );
      ...
      rerender(
        <Card selected variant="ghost" data-testid="selected-card">
          Content
        </Card>,
      );
  ...
  describe("interactions", () => {
    ...
    it("does not call onClick when disabled", async () => {
      ...
      render(
        <Card onClick={handleClick} disabled data-testid="disabled-clickable">
          Content
        </Card>,
      );
    ...
    it("does not call onClick when loading", async () => {
      ...
      render(
        <Card onClick={handleClick} loading data-testid="loading-clickable">
          Content
        </Card>,
      );
  ...
  describe("custom styling", () => {
    ...
    it("applies custom headerClassName", () => {
      render(
        <Card title="Title" headerClassName="custom-header" data-testid="card">
          Content
        </Card>,
      );
    ...
    it("applies custom bodyClassName", () => {
      render(
        <Card bodyClassName="custom-body" data-testid="card">
          Content
        </Card>,
      );
    ...
    it("applies custom footerClassName", () => {
      const footer = <div>Footer</div>;
      render(
        <Card footer={footer} footerClassName="custom-footer" data-testid="card">
          Content
        </Card>,
      );
  ...
  describe("HTML attributes", () => {
    it("forwards HTML div attributes", () => {
      render(
        <Card data-testid="attributed-card" id="card-id" role="region">
          Content
        </Card>,
      );
    ...
    it("does not forward component-specific props as HTML attributes", () => {
      render(
        <Card variant="interactive" size="lg" hoverable data-testid="props-card">
          Content
        </Card>,
      );
