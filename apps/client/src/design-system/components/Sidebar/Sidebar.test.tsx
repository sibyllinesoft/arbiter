...
describe('Sidebar', () => {
  ...
  describe('active states', () => {
    ...
    it('handles items without active state', () => {
      const itemsWithoutActive = mockFlatItems.map(item => ({ ...item, active: false }));
  ...
  describe('width and layout', () => {
    it('applies small width class', () => {
      render(<Sidebar items={mockFlatItems} width="sm" />);
    ...
    it('applies large width class', () => {
      render(<Sidebar items={mockFlatItems} width="lg" />);
      const sidebar = screen.getByRole('complementary');
  ...
  describe('collapsed state', () => {
    ...
    it('adjusts header padding when collapsed', () => {
      ...
      render(<Sidebar items={mockFlatItems} collapsed header={header} />);
    ...
    it('adjusts footer padding when collapsed', () => {
      ...
      render(<Sidebar items={mockFlatItems} collapsed footer={footer} />);
  ...
  describe('custom styling', () => {
    it('applies custom className', () => {
      const { container } = render(<Sidebar items={mockFlatItems} className="custom-sidebar" />);
      ...
      const itemsWithLongLabels: SidebarNavItem[] = [
        {
          id: 'long-label',
          label:
            'This is a very long label that should be truncated properly to fit within the sidebar width constraints',
          icon: <Home />,
        },
      ];
