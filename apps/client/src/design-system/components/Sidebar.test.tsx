...
describe('Sidebar', () => {
  ...
  describe('item clicks', () => {
    ...
    it('calls custom onClick when item has one', async () => {
      ...
      const itemsWithCustomClick = [{ ...mockFlatItems[0], onClick: customClick }];
    ...
    it('handles both onItemClick and custom onClick', async () => {
      ...
      const handleItemClick = vi.fn();
      const customClick = vi.fn();
      const itemsWithBoth = [{ ...mockFlatItems[0], onClick: customClick }];
  ...
  describe('collapsed state', () => {
    ...
    it('adjusts header padding when collapsed', () => {
      ...
      const { container } = render(<Sidebar items={mockFlatItems} collapsed header={header} />);
    ...
    it('adjusts footer padding when collapsed', () => {
      ...
      const { container } = render(<Sidebar items={mockFlatItems} collapsed footer={footer} />);
