...
const variantStyles = {
  ...
  secondary:
    'bg-secondary text-secondary-foreground hover:bg-secondary/80 dark:bg-secondary/80 dark:text-secondary-foreground',
  destructive:
  ...
  outline: 'text-foreground border dark:border-graphite-600',
};
