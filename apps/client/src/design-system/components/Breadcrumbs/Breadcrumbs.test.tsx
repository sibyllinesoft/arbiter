...
describe("Breadcrumbs", () => {
  ...
  describe("current page", () => {
    ...
    it("handles multiple items without current flag", () => {
      const itemsWithoutCurrent = mockBreadcrumbItems.map((item) => {
  ...
  describe("click handling", () => {
    ...
    it("calls item onClick when provided", async () => {
      ...
      const itemsWithOnClick = [{ ...mockBreadcrumbItems[0]!, onClick: customClick }];
    ...
    it("does not render button for non-clickable items", () => {
      const nonClickableItems: BreadcrumbItem[] = [{ id: "static", label: "Static Item" }];
  ...
  describe("icons", () => {
    ...
    it("does not show home icon when showHomeIcon is false", () => {
      ...
      expect((homeItem?.firstChild as Element)?.querySelector("svg")).toBeFalsy();
    });
  ...
  describe("edge cases", () => {
    it("handles items with empty labels", () => {
      const itemsWithEmptyLabels: BreadcrumbItem[] = [{ id: "empty", label: "", href: "/" }];
      ...
      const itemsWithLongLabels: BreadcrumbItem[] = [
        {
          id: "long",
          label:
            "This is a very long breadcrumb label that should be truncated to prevent layout issues",
          href: "/long",
        },
      ];
    ...
    it("handles items without IDs gracefully", () => {
      ...
      const itemsWithoutIds = [{ id: "", label: "No ID", href: "/" }];
