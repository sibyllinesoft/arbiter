/**
 * CUE specification viewer component.
 * Displays and optionally edits CUE source with validation and metadata.
 */
import {
  AlertTriangle,
  Check,
...
/** Props for the CueViewer component */
...
/** Validation error from CUE parsing or schema checking */
...
/**
 * CUE specification viewer with metadata display and optional editing.
 * Supports validation error highlighting and resolved data preview.
 */
