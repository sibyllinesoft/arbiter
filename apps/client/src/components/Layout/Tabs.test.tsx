...
describe('Tabs', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders all tab headers', () => {
      render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={mockTabs} />);
    ...
    it('renders active tab content', () => {
      render(<Tabs activeTab="tab2" onTabChange={mockOnTabChange} tabs={mockTabs} />);
    ...
    it('renders empty content when no active tab matches', () => {
      render(<Tabs activeTab="nonexistent" onTabChange={mockOnTabChange} tabs={mockTabs} />);
  ...
  describe('Tab States and Styling', () => {
    ...
    it('applies disabled styling and attributes to disabled tabs', () => {
      render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={mockTabsWithDisabled} />);
  ...
  describe('Badge Rendering', () => {
    it('renders string badges correctly', () => {
      render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={mockTabsWithBadges} />);
    ...
    it('renders number badges correctly', () => {
      render(<Tabs activeTab="tab2" onTabChange={mockOnTabChange} tabs={mockTabsWithBadges} />);
    ...
    it('does not render badge when badge prop is undefined', () => {
      render(<Tabs activeTab="tab3" onTabChange={mockOnTabChange} tabs={mockTabsWithBadges} />);
  ...
  describe('Dynamic Tab Updates', () => {
    it('updates content when activeTab prop changes', () => {
      const { rerender } = render(
        <Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={mockTabs} />
      );

      expect(screen.getByTestId('tab1-content')).toBeInTheDocument();

      rerender(<Tabs activeTab="tab2" onTabChange={mockOnTabChange} tabs={mockTabs} />);
    ...
    it('handles dynamic tabs array changes', () => {
      ...
      const { rerender } = render(
        <Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={initialTabs} />
      );

      expect(screen.getAllByRole('tab')).toHaveLength(2);

      rerender(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={mockTabs} />);
    ...
    it('handles empty tabs array gracefully', () => {
      render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={[]} />);
  ...
  describe('Edge Cases', () => {
    it('handles tabs with identical labels', () => {
      ...
      render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={duplicateLabelTabs} />);
    ...
    it('handles very long tab labels', () => {
      ...
      render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={longLabelTabs} />);
    ...
    it('handles null or undefined content', () => {
      ...
      expect(() => {
        render(<Tabs activeTab="tab1" onTabChange={mockOnTabChange} tabs={nullContentTabs} />);
      }).not.toThrow();
    });
  });
  ...
  describe('Performance', () => {
    it('handles large number of tabs efficiently', () => {
      ...
      render(<Tabs activeTab="tab0" onTabChange={mockOnTabChange} tabs={manyTabs} />);
