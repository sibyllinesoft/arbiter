...
describe("Database Coverage Tests", () => {
  ...
  describe("Project operations", () => {
    ...
    it("should handle non-existent project deletion", async () => {
      await expect(
        db.deleteProject("non-existent-project")
  ...
  describe("Fragment operations", () => {
    ...
    it("should handle fragment deletion", async () => {
      ...
      const fragment = db.getFragment(projectId, fragmentPath);
    ...
    it("should handle non-existent fragment deletion", async () => {
      ...
      await expect(
        db.deleteFragment(projectId, "non/existent")
  ...
  describe("Database maintenance", () => {
    ...
    it("should handle database close", () => {
      ...
      const testDb = new SpecWorkbenchDB(testConfig);
      testDb.close(); // Should not throw
    });

    it("should handle health check failure", async () => {
      // Close the main database to simulate failure
      const originalPrepare = db['db'].prepare;
      db['db'].prepare = () => {
