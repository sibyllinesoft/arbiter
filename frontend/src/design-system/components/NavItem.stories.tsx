...
const meta: Meta<typeof NavItem> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Flexible navigation item component for various navigation contexts. Supports different variants, sizes, and interactive states.',
      },
    },
  },
  tags: ['autodocs'],
    ...
    <div className="w-80 space-y-6">
      <div className="p-4 bg-white rounded-lg border">
        <NavGroup title="Main Navigation">
          ...
          <NavItem icon={<Folder className="h-4 w-4" />}>
            Projects
          </NavItem>
        </NavGroup>
    ...
    <div className="w-80 space-y-6">
      <div className="p-4 bg-white rounded-lg border">
        <NavGroup title="Main Navigation" collapsible>
          ...
          <NavItem icon={<Users className="h-4 w-4" />}>
            Team
          </NavItem>
          <NavItem icon={<Folder className="h-4 w-4" />}>
            Projects
        ...
        <NavGroup title="Administration" collapsible defaultCollapsed className="mt-6">
          ...
          <NavItem icon={<Bell className="h-4 w-4" />}>
            Notifications
          </NavItem>
        </NavGroup>
    ...
    <div className="w-80 space-y-6">
      <div className="p-4 bg-white rounded-lg border">
        <NavGroup title="Quick Actions">
          ...
          <NavItem icon={<Share className="h-4 w-4" />}>
            Share Workspace
          </NavItem>
        </NavGroup>
        ...
        <NavGroup title="Favorites" className="mt-6">
          ...
          <NavItem icon={<Heart className="h-4 w-4" />}>
            Liked Projects
          </NavItem>
          <NavItem icon={<Bookmark className="h-4 w-4" />}>
            Bookmarks
          </NavItem>
        </NavGroup>
      </div>
