...
describe('NavItem', () => {
  ...
  describe('icons', () => {
    it('renders with start icon', () => {
      render(
        <NavItem icon={<Home data-testid="start-icon" />}>
          With Icon
        </NavItem>
      )
    ...
    it('renders with end icon', () => {
      render(
        <NavItem endIcon={<ChevronRight data-testid="end-icon" />}>
          With End Icon
        </NavItem>
      )
  ...
  describe('badges', () => {
    ...
    it('renders with ReactNode badge', () => {
      render(
        <NavItem badge={<span data-testid="custom-badge">Custom</span>}>
          With Custom Badge
        </NavItem>
      )
  ...
  describe('styling and accessibility', () => {
    ...
    it('truncates long text content', () => {
      render(
        <NavItem>
          Very Long Navigation Item Text That Should Be Truncated
        </NavItem>
      )
