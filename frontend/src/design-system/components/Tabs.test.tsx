...
describe('Tabs', () => {
  ...
  describe('controlled vs uncontrolled', () => {
    ...
    it('works in controlled mode', async () => {
      ...
      rerender(
        <Tabs items={mockTabItems} activeTab="tab1" onChange={handleChange} />
      )
      expect(firstPanel).toHaveClass('block')
    })
  ...
  describe('custom styling', () => {
    it('applies custom className to container', () => {
      const { container } = render(
        <Tabs items={mockTabItems} className="custom-tabs" />
      )
    ...
    it('applies custom contentClassName to content area', () => {
      const { container } = render(
        <Tabs items={mockTabItems} contentClassName="custom-content" />
      )
