...
## Remaining
- Rust plugin: externalize all generated code/assets into `packages/cli/src/templates/rust` and route plugin through TemplateResolver (Dockerfiles, compose, main/config, services/models/tests, GitHub Actions).
...
- Template hygiene: consider moving dev requirements and auth/test helper snippets in Python plugin into templates for full consistency.
